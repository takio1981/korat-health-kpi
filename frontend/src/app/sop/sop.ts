...
const SYSTEMS: SopSystem[] = [
{
  ...
  notes:['Force Logout → ผู้ถูก logout จะถูกตัด session ใน ~30 วินาที (session cache TTL)','Sync users to KHD: เปรียบเทียบ 4 สถานะ matched/different/local_only/khd_only'],
},{
